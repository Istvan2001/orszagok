...
function sorsol(){
    ...
    sz+='<img src="'+adatok0[veletlen].flag+'" class="kep" >';
...
function ellenoriz(){
    ...
    if (adatok0[veletlen].population==nepesseg+(nepesseg/100*10) ||adatok0[veletlen].population==nepesseg-(nepesseg/100*10) )
